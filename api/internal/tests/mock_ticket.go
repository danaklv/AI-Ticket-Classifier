...
func (m *MockTicketRepository) Create(ctx context.Context, t *models.Ticket) error {
	m.ctrl.T.Helper()
...
func (mr *MockTicketRepositoryMockRecorder) Create(ctx, t interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockTicketRepository)(nil).Create), ctx, t)
}

// GetAll mocks base method.
func (m *MockTicketRepository) GetAll(ctx context.Context) ([]models.Ticket, error) {
	m.ctrl.T.Helper()
...
func (mr *MockTicketRepositoryMockRecorder) GetAll(ctx interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAll", reflect.TypeOf((*MockTicketRepository)(nil).GetAll), ctx)
}
